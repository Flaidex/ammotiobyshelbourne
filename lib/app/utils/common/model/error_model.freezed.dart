...
class _$ErrorModelImpl implements _ErrorModel {
  const _$ErrorModelImpl({final List<String>? errors}) : _errors = errors;
  ...
  @override
  String toString() {
    return 'ErrorModel(errors: $errors)';
  }
...
abstract class _ErrorModel implements ErrorModel {
  const factory _ErrorModel({final List<String>? errors}) = _$ErrorModelImpl;
